...
import com.tesu.creditgold.adapter.ViewPagerAdapter;
...
public class GuideActivity extends BaseActivity {
	...
	private void initData() {
		...
		view2 = this.getLayoutInflater().inflate(R.layout.guide_view02, null);
		view3 = this.getLayoutInflater().inflate(R.layout.guide_view03, null);
		...
		tv_skip_two=(TextView)view2.findViewById(R.id.tv_skip_two);
		tv_skip_three=(TextView)view3.findViewById(R.id.tv_skip_three);
...
//		// 实例化开始按钮
		...
		tv_skip_two.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(GuideActivity.this, MainActivity.class);
		...
		tv_skip_three.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(GuideActivity.this, MainActivity.class);
