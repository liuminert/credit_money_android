...
public class AddImageAdapter extends BaseAdapter {
    ...
    public AddImageAdapter(Context context, List<Bitmap> bitmapList, PopupWindow popupWindow, View view, List<String> pics, int num,ImageCallBack imageCallBack) {
        mContext = context;
