...
public class AddBusinessAdapter extends BaseAdapter {
    ...
    public AddBusinessAdapter(Context context, List<Bitmap> bitmapList, PopupWindow popupWindow, View view, List<String> pics, int num, ImageCallBack imageCallBack) {
        mContext = context;
