...
public class AddLicencePicAdapter extends BaseAdapter {
    ...
    public AddLicencePicAdapter(Context context, List<Bitmap> bitmapList, PopupWindow popupWindow, View view, List<String> pics, int num,ImageCallBack imageCallBack) {
        mContext = context;
