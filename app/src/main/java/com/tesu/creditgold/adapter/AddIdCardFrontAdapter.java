...
public class AddIdCardFrontAdapter extends BaseAdapter {
    ...
    public AddIdCardFrontAdapter(Context context, List<Bitmap> bitmapList, PopupWindow popupWindow, View view, List<String> pics, int num, ImageCallBack imageCallBack) {
        mContext = context;
