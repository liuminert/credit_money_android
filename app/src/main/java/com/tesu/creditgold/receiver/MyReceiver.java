package com.tesu.creditgold.receiver;
...
import com.tesu.creditgold.activity.TestActivity;
	...
	public void onReceive(Context context, Intent intent) {
		try {
			...
			if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
				...
				//打开自定义的Activity
				Intent i = new Intent(context, MyInformationListActivity.class);
				i.putExtra("isFromReceiver",true);
				i.putExtras(bundle);
